            ...
            <div class="col-12">
                <div class="card card-body">
                    ...
                    <?php
                            ...
                            if (isset($_SESSION['error-add-category'])) {
                                ?>
                                <div class="alert alert-danger">
                                    <?php echo $_SESSION['error-add-category'];?>
                                </div>
                                <?php
                                unset($_SESSION['error-add-category']);
                            }
                    ?>
                    <form class="form-horizontal mt-4" action="" enctype="multipart/form-data" method="POST">
                        ...
                        <div>
                            <input type="submit" class="btn btn-success text-white mdi mdi-account-plus" name="add-categ" value="Add Category">
                        </div>
                    </form>
                </div>
            </div>
