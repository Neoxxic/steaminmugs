                    ...
                    <div class="navbar-brand">
                        <a href="index.php" class="logo">
                            ...
                            <b class="logo-icon">
                                ...
                                <!-- Dark Logo icon -->
                                <img src="../../assets/images/NooneMugs2.png" style="height: 2.5em; width: 2.5em;" alt="homepage" class="dark-logo" />
                                <!-- Light Logo icon -->
                                <img src="../../assets/images/NooneMugs2.png" style="height: 2.5em; width: 2.5em;" alt="homepage" class="light-logo" />
                            </b>
                            <!--End Logo icon -->
                            <!-- Logo text -->
